...
## PDF indirme MinIO (opsiyonel)

Backend PDF olusturup MinIO/S3 depoya yukler; kullanici presigned URL ile oradan indirir. Environment: MINIO_ENDPOINT, MINIO_ACCESS_KEY, MINIO_SECRET_KEY, MINIO_BUCKET, MINIO_USE_FOR_PDF=1. Frontend degisikligi gerekmez.
