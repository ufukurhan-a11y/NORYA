...
def _apply_he(_UI, _LABELS, _NORYA, _WHY, _CTA, _HUB, _COMP):
    ...
    _HUB["he"] = {
        ...
        "trust_stats": [{"value": "98.7%", "label": "דיוק הסיווג", "sub": "הערכה פנימית של הפלטפורמה"}, {"value": "9+", "label": "שפות", "sub": "דוחות מלאים עם הקשר רפואי"}, {"value": "QR", "label": "PDF מאומת", "sub": "סיכום מוכן לרופא ניתן לשיתוף"}],
        ...
        "matrix_rows": [
            ...
            {"norya": "98.7% · הערכה פנימית", "chatgpt": "לא גלוי", "kantesti": "לא גלוי", "siphox": "לא גלוי", "wizey": "לא גלוי", "generic": "לא גלוי"},
        ],
...
def _apply_hi(_UI, _LABELS, _NORYA, _WHY, _CTA, _HUB, _COMP):
    ...
    _HUB["hi"] = {
        ...
        "trust_stats": [{"value": "98.7%", "label": "वर्गीकरण सटीकता", "sub": "आंतरिक प्लेटफ़ॉर्म मूल्यांकन"}, {"value": "9+", "label": "भाषाएँ", "sub": "चिकित्सा संदर्भ के साथ पूर्ण रिपोर्ट"}, {"value": "QR", "label": "सत्यापित PDF", "sub": "डॉक्टर के लिए तैयार साझा करने योग्य सारांश"}],
...
def _apply_ar(_UI, _LABELS, _NORYA, _WHY, _CTA, _HUB, _COMP):
    ...
    _HUB["ar"] = {
        ...
        "trust_stats": [{"value": "98.7%", "label": "دقة التصنيف", "sub": "تقييم داخلي للمنصة"}, {"value": "9+", "label": "لغات", "sub": "تقارير كاملة مع سياق طبي"}, {"value": "QR", "label": "PDF موثق", "sub": "ملخص جاهز للطبيب قابل للمشاركة"}],
        ...
        "matrix_rows": [
            ...
            {"norya": "98.7% · تقييم داخلي", "chatgpt": "غير مُفصح عنه", "kantesti": "غير مُفصح عنه", "siphox": "غير مُفصح عنه", "wizey": "غير مُفصح عنه", "generic": "غير مُفصح عنه"},
        ],
