    ...
    return [
        ...
        Section(
            ...
            body_html=(
                ...
                "For more on kidney markers, see our guide on <a href=\"/blog/creatinine-egfr-meaning\">creatinine and eGFR</a>.</li>"
    ...
    return [
        ...
        Section(
            ...
            body_html=(
                ...
                "<a href=\"/blog/creatinine-egfr-meaning\">kreatinin ve eGFR rehberimize</a> bakın), metabolik sendrom, "
...
def _sections_it() -> list:
    ...
    return [
        ...
        Section(id="high-uric-acid-causes", level=2, heading="Cause dell'acido urico alto",
                body_html="<p><strong>Fattori alimentari:</strong> dieta ricca di purine (frattaglie, frutti di mare, carne rossa), alcol (soprattutto birra), bevande zuccherate con fruttosio, obesità. <strong>Condizioni mediche:</strong> nefropatia cronica (vedi <a href=\"/blog/creatinine-egfr-meaning\">creatinina ed eGFR</a>), sindrome metabolica, disordini mieloproliferativi. <strong>Farmaci:</strong> diuretici tiazidici, aspirina a basse dosi, ciclosporina.</p>"),
...
def _sections_hi() -> list:
    ...
    return [
        ...
        Section(id="high-uric-acid-causes", level=2, heading="उच्च यूरिक एसिड के कारण",
                body_html="<p><strong>आहार कारक:</strong> प्यूरीन-समृद्ध आहार (अंग मांस, समुद्री भोजन, लाल मांस), शराब (विशेषकर बीयर), फ्रुक्टोज युक्त पेय, मोटापा। <strong>चिकित्सा स्थितियाँ:</strong> क्रोनिक किडनी रोग (<a href=\"/blog/creatinine-egfr-meaning\">क्रिएटिनिन और eGFR</a> देखें), मेटाबोलिक सिंड्रोम। <strong>दवाएँ:</strong> मूत्रवर्धक, कम खुराक एस्पिरिन।</p>"),
...
def _sections_ar() -> list:
    ...
    return [
        ...
        Section(id="high-uric-acid-causes", level=2, heading="أسباب ارتفاع حمض اليوريك",
                body_html="<p><strong>عوامل غذائية:</strong> نظام غذائي غني بالبيورينات (أحشاء، مأكولات بحرية، لحوم حمراء)، الكحول (خاصة البيرة)، مشروبات الفركتوز، السمنة. <strong>حالات طبية:</strong> أمراض الكلى المزمنة (انظر <a href=\"/blog/creatinine-egfr-meaning\">الكرياتينين ومعدل الترشيح الكبيبي</a>)، المتلازمة الأيضية. <strong>أدوية:</strong> مدرات البول، الأسبرين بجرعة منخفضة.</p>"),
