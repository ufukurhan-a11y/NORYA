...
def _en_ai_blood_test_analyzer() -> dict:
    return {
        "meta_title": "AI Blood Test Analyzer — Structured Lab Report Summary | NoryaAI",
        "meta_description": "Upload your blood test and get a structured, doctor-ready report from NoryaAI. Health score, flagged markers, reference ranges, and plain-language explanations — not a generic chatbot answer.",
        "hero_title": "AI Blood Test Analyzer — Clear Results, Not Chatbot Guesses",
        "hero_sub": "Upload your lab report and receive a structured, doctor-ready summary. Health score, reference ranges, plain-language explanations, and highlighted findings — all in one clean report.",
        "hero_trust_line": "Purpose-built AI for blood tests — not a generic chatbot",
        ...
        "section_compare_sub": "General-purpose AI can write essays and answer trivia — but blood tests need structure, medical reference data, and a format your doctor can actually use.",
        ...
        "compare_cta_text": "See how NoryaAI works",
        ...
        "section_cta_title": "Ready to understand your blood test?",
