    ...
    return [
        ...
        Section(
            ...
            body_html=(
                ...
                "İlgili belirteçler için <a href=\"/tr/blog/calcium-high-meaning\">kalsiyum</a> ve "
                "<a href=\"/tr/blog/potassium-high-meaning\">potasyum</a> rehberlerimize bakın.</li>"
...
def _sections_de() -> list:
    ...
    return [
        ...
        Section(id="role-in-body", level=2, heading="Die Rolle von Magnesium im Körper",
                body_html="<p>Magnesium ist an über 300 Enzymsystemen beteiligt: Energieproduktion (ATP), Muskelfunktion, Nervenfunktion, Herzrhythmus, Knochengesundheit, Blutzuckerregulation und Blutdruck. Siehe auch unsere Leitfäden zu <a href=\"/de/blog/calcium-high-meaning\">Kalzium</a> und <a href=\"/de/blog/potassium-high-meaning\">Kalium</a>.</p>"),
...
def _sections_fr() -> list:
    ...
    return [
        ...
        Section(id="role-in-body", level=2, heading="Le rôle du magnésium dans le corps",
                body_html="<p>Le magnésium intervient dans plus de 300 systèmes enzymatiques : production d'énergie (ATP), fonction musculaire et nerveuse, rythme cardiaque, santé osseuse, glycémie et pression artérielle. Voir nos guides sur <a href=\"/fr/blog/calcium-high-meaning\">le calcium</a> et <a href=\"/fr/blog/potassium-high-meaning\">le potassium</a>.</p>"),
...
def _sections_he() -> list:
    ...
    return [
        ...
        Section(id="role-in-body", level=2, heading="תפקיד המגנזיום בגוף",
                body_html="<p>מגנזיום מעורב ביותר מ-300 מערכות אנזימטיות: ייצור אנרגיה (ATP), תפקוד שרירים ועצבים, קצב לב, בריאות עצמות, ויסות סוכר בדם ולחץ דם. ראו גם <a href=\"/he/blog/calcium-high-meaning\">סידן</a> ו-<a href=\"/he/blog/potassium-high-meaning\">אשלגן</a>.</p>"),
...
def _sections_hi() -> list:
    ...
    return [
        ...
        Section(id="role-in-body", level=2, heading="शरीर में मैग्नीशियम की भूमिका",
                body_html="<p>मैग्नीशियम 300 से अधिक एंजाइम प्रणालियों में शामिल है: ऊर्जा उत्पादन (ATP), मांसपेशी और तंत्रिका कार्य, हृदय गति, हड्डी स्वास्थ्य, रक्त शर्करा और रक्तचाप। <a href=\"/hi/blog/calcium-high-meaning\">कैल्शियम</a> और <a href=\"/hi/blog/potassium-high-meaning\">पोटैशियम</a> गाइड भी देखें।</p>"),
...
def _sections_ar() -> list:
    ...
    return [
        ...
        Section(id="role-in-body", level=2, heading="دور المغنيسيوم في الجسم",
                body_html="<p>المغنيسيوم يشارك في أكثر من 300 نظام إنزيمي: إنتاج الطاقة (ATP)، وظيفة العضلات والأعصاب، نظم القلب، صحة العظام، تنظيم سكر الدم وضغط الدم. انظر أدلتنا حول <a href=\"/ar/blog/calcium-high-meaning\">الكالسيوم</a> و<a href=\"/ar/blog/potassium-high-meaning\">البوتاسيوم</a>.</p>"),
