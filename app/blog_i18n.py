    ...
    return Article(
        ...
        sections_by_lang={
            ...
            "en": [
                ...
                Section(id="why-low", level=2, heading="Why might albumin be low?", body_html="<p>Low levels can be linked to liver or kidney disease, long-term poor intake or malnutrition, serious infection or inflammation, or protein loss from the gut. Your doctor will consider your history, examination, and other tests (e.g. total protein, liver and kidney tests) together.</p>"),
                Section(id="how-to-read", level=2, heading="How is the result interpreted?", body_html="<p>Reference ranges vary by lab. One low value does not always mean a serious condition; a mild drop can sometimes be temporary or diet-related. Interpretation and any follow-up tests should be done by your doctor.</p>"),
                Section(id="cta", level=2, heading="Make sense of your results", body_html="<p>If you want to see your blood results in a clear, structured summary, you can <a href=\"/analyze\">run an analysis</a>. For diagnosis and treatment, always speak with your doctor.</p>"),
...
def _article_total_protein_high_low() -> Article:
    ...
    return Article(
        ...
        sections_by_lang={
            ...
            "en": [Section(id="content", level=2, heading="What do high or low total protein levels mean?", body_html="<p><strong>Total protein</strong> is albumin plus globulins; it is linked to liver and immunity. High or low can be due to inflammation, liver or kidney disease, or nutrition. It does not make a diagnosis alone; your doctor interprets it with albumin and liver or kidney tests. Discuss your result with a doctor.</p>"), Section(id="disclaimer", level=2, heading="Disclaimer", body_html="<p><strong>For information only.</strong> <a href=\"/analyze\">Analyze</a></p>")],
...
def _article_sodium_low() -> Article:
    ...
    content_en = "<p><strong>Sodium</strong> is one of the main electrolytes in blood; it is needed for fluid balance and nerve and muscle function. Low sodium alone is not a diagnosis; excess fluid intake, diuretics, heart or kidney conditions, or hormone imbalances are assessed by your doctor. If you have a very low result or symptoms, see a doctor.</p>"
    subtitles = {"tr": "Sodyum kandaki başlıca elektrolittir; düşüklüğü sıvı dengesi, ilaç ve böbrek hekimle birlikte değerlendirilir.", "en": "Sodium is a key electrolyte in blood; low sodium is assessed with your doctor (fluid balance, medicines, kidney).", "es": "El sodio es un electrolito clave; un valor bajo se valora con el médico (líquidos, medicación, riñón).", "de": "Natrium ist ein zentraler Blutelektrolyt; zu niedrig beurteilt der Arzt (Flüssigkeit, Medikamente, Niere).", "fr": "Le sodium est un électrolyte clé ; un taux bas est évalué avec le médecin (équilibre hydrique, médicaments, rein).", "it": "Il sodio è un elettrolita chiave; un valore basso si valuta con il medico (liquidi, farmaci, rene).", "he": "נתרן הוא אלקטרוליט מרכזי; ערך נמוך יבדוק הרופא (נוזלים, תרופות, כליות).", "hi": "सोडियम खून में अहम इलेक्ट्रोलाइट है; लो सोडियम डॉक्टर फ्लूड, दवा, किडनी के साथ आंकलन करेंगे।", "ar": "الصوديوم إلكتروليت أساسي؛ انخفاضه يقيّمه الطبيب (التوازن المائي، الأدوية، الكلية)."}
    ...
    sections_by_lang = {
        ...
        "en": [Section(id="content", level=2, heading="What does low sodium mean?", body_html=content_en), Section(id="disclaimer", level=2, heading="Disclaimer", body_html=disclaimer_en)],
...
def _article_potassium_high() -> Article:
    ...
    sections_by_lang = {
        ...
        "en": [Section(id="content", level=2, heading="What does high potassium mean?", body_html="<p><strong>Potassium</strong> is an important electrolyte for heart rhythm and muscle and nerve function. High potassium alone is not a diagnosis; kidney function, medications (e.g. some blood pressure drugs), red cell breakdown, or diet are considered by your doctor. Severe elevation may need urgent evaluation; discuss your result with a doctor.</p>"), Section(id="disclaimer", level=2, heading="Disclaimer", body_html=d["en"])],
...
def _article_calcium_high() -> Article:
    ...
    cat = {"tr": "Biyobelirteçler", "en": "Biomarkers", "es": "Biomarcadores", "de": "Biomarker", "fr": "Biomarqueurs", "it": "Biomarcatori", "he": "ביומרקרים", "hi": "बायोमार्कर", "ar": "المؤشرات الحيوية"}
    titles = {"tr": "Kalsiyum yüksek ne demek?", "en": "What does high calcium mean?", "es": "Calcio alto: ¿qué implica?", "de": "Kalzium erhöht: Was bedeutet das?", "fr": "Calcium élevé : qu'est-ce que ça indique ?", "it": "Calcio alto: cosa significa?", "he": "מה אומר ערך סידן גבוה?", "hi": "कैल्शियम हाई का क्या मतलब है?", "ar": "ماذا يعني ارتفاع الكالسيوم؟"}
    excerpts = {"tr": "Kalsiyum kemik ve sinir-kas için önemlidir; yüksekliği tek başına teşhis değildir, paratiroid ve böbrek hekimle birlikte değerlendirilir.", "en": "Calcium is important for bones and nerves and muscles. A high level alone is not a diagnosis—your doctor will consider parathyroid and kidney.", "es": "El calcio es importante para huesos, nervios y músculos. Un valor alto por sí solo no es un diagnóstico; el médico valora paratiroides y riñón.", "de": "Kalzium ist wichtig für Knochen, Nerven und Muskeln. Erhöhung allein ist keine Diagnose—der Arzt bezieht Nebenschilddrüse und Niere ein.", "fr": "Le calcium est important pour les os, les nerfs et les muscles. Un taux élevé seul ne fait pas un diagnostic ; le médecin évalue parathyroïde et rein.", "it": "Il calcio è importante per ossa, nervi e muscoli. Un valore alto da solo non è una diagnosi; il medico valuta paratiroide e rene.", "he": "סידן חשוב לעצמות, לעצבים ולשרירים. ערך גבוה לבדו אינו אבחנה—הרופא יבדוק יותרת המגן וכליות.", "hi": "कैल्शियम हड्डियों, नसों और मांसपेशियों के लिए जरूरी है। हाई लेवल अकेले निदान नहीं—डॉक्टर पैराथायरॉइड और किडनी देखेंगे।", "ar": "الكالسيوم مهم للعظام والأعصاب والعضلات. ارتفاعه وحده ليس تشخيصاً—الطبيب يقيّم الغدة الجار درقية والكلى."}
    ...
    c_en = "<p><strong>Calcium</strong> is needed for bone, nerve, and muscle function. High blood calcium alone is not a diagnosis; parathyroid glands, kidney, vitamin D, or certain medications are assessed by your doctor. If your level is clearly high, see a doctor.</p>"
    d_tr = "<p><strong>Bilgilendirme amaçlıdır.</strong> <a href=\"/analyze\">Analiz</a></p>"
    d_en = "<p><strong>For information only.</strong> <a href=\"/analyze\">Analyze</a></p>"
    sec = {"tr": [Section(id="content", level=2, heading="Kalsiyum yüksekliği ne anlama gelir?", body_html=c_tr), Section(id="disclaimer", level=2, heading="Uyarı", body_html=d_tr)], "en": [Section(id="content", level=2, heading="What does high calcium mean?", body_html=c_en), Section(id="disclaimer", level=2, heading="Disclaimer", body_html=d_en)]}
    return Article(id="calcium-high-meaning", published_at=published, read_minutes=4, cover_image=cover, category=cat, slugs=slugs, titles=titles, subtitles=sub, excerpts=excerpts, seo_titles={k: v + " | Norya Blog" for k, v in titles.items()}, seo_descriptions={k: "Calcium. For information only." if k == "en" else "Kalsiyum. Bilgilendirme amaçlı." if k == "tr" else "Solo informativo." for k in titles}, cover_alt={l: "Calcium — Norya" for l in ("en", "de", "fr", "it")} | {"tr": "Kalsiyum kan tahlili — Norya", "es": "Calcio — Norya", "he": "סידן — Norya", "hi": "कैल्शियम — Norya", "ar": "الكالسيوم — Norya"}, sections_by_lang=sec)
