...
def _article_mch_high_low() -> Article:
    ...
    subs = {"tr": "MCH, bir kırmızı kan hücresindeki ortalama hemoglobin miktarını gösterir; yüksek veya düşük tek başına teşhis değildir.", "en": "MCH is the average amount of hemoglobin per red blood cell; high or low is not a diagnosis on its own.", "es": "MCH es la cantidad media de hemoglobina por glóbulo rojo; alto o bajo no es un diagnóstico por sí solo.", "de": "MCH ist die durchschnittliche Hämoglobinmenge pro Erythrozyt; zu hoch oder zu niedrig ist keine Diagnose für sich.", "fr": "Le MCH est la quantité moyenne d'hémoglobine par globule rouge ; haut ou bas seul ne fait pas un diagnostic.", "it": "L'MCH è la quantità media di emoglobina per globulo rosso; alto o basso da solo non è una diagnosi.", "he": "MCH הוא כמות ההמוגלובין הממוצעת לכדורית אדומה; גבוה או נמוך לבדו אינו אבחנה.", "hi": "MCH एक लाल रक्त कोशिका में औसत हीमोग्लोबिन है; हाई या लो अकेले निदान नहीं।", "ar": "MCH هو متوسط كمية الهيموغلوبين في كرية حمراء؛ ارتفاع أو انخفاض وحده ليس تشخيصاً."}
...
def _article_mchc_low() -> Article:
    ...
    subs = {"tr": "MCHC, kırmızı kan hücresindeki hemoglobin yoğunluğunu gösterir; düşüklüğü tek başına teşhis değildir.", "en": "MCHC reflects the concentration of hemoglobin in red blood cells; a low value alone is not a diagnosis.", "es": "MCHC refleja la concentración de hemoglobina en glóbulos rojos; un valor bajo por sí solo no es un diagnóstico.", "de": "MCHC gibt die Hämoglobinkonzentration in den Erythrozyten an; ein niedriger Wert allein ist keine Diagnose.", "fr": "Le MCHC reflète la concentration d'hémoglobine dans les globules rouges ; un taux bas seul ne fait pas un diagnostic.", "it": "L'MCHC riflette la concentrazione di emoglobina nei globuli rossi; un valore basso da solo non è una diagnosi.", "he": "MCHC משקף את ריכוז ההמוגלובין בכדוריות האדומות; ערך נמוך לבדו אינו אבחנה.", "hi": "MCHC लाल रक्त कोशिकाओं में हीमोग्लोबिन की सघनता दिखाता है; लो अकेले निदान नहीं।", "ar": "MCHC يعكس تركيز الهيموغلوبين في كريات الدم الحمراء؛ انخفاضه وحده ليس تشخيصاً."}
