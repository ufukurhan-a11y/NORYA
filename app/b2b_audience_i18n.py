...
def _page_hospitals_en() -> Dict[str, Any]:
    return {
        ...
        "who_secondary": "University Hospitals & Specialty Clinics",
        "who_points": ["High-volume laboratory services", "Multi-campus operations", "International patient services"],
        "features_title": "Premium Enterprise Features",
        "features": [
            {
                "title": "Advanced AI Analytics",
                "badge": "AI POWERED",
                "desc": "Automatic insights from your lab data. Detects abnormal patterns, provides trend analysis, and supports clinical decision-making.",
                "points": ["Pattern Recognition", "Trend Analysis", "Risk Scoring"],
            },
            {
                "title": "Real-time Monitoring",
                "badge": "REAL-TIME",
                "desc": "Monitor your entire laboratory workflow live. Instant notifications, performance metrics, and operational dashboard.",
                "points": ["Live Dashboard", "Instant Alerts", "KPI Tracking"],
            },
            {
                "title": "Custom Integration",
                "badge": "CUSTOM",
                "desc": "Seamless integration with your existing HIS, LIS, and EHR systems. RESTful API, HL7 FHIR support, and custom connectors.",
                "points": ["HL7 FHIR", "RESTful API", "Webhook Support"],
            },
            {
                "title": "Compliance & Security",
                "badge": "CERTIFIED",
                "desc": "KVKK, HIPAA, and GDPR compliant. Full audit trails, role-based access control, and end-to-end encryption.",
                "points": ["KVKK / GDPR", "HIPAA Ready", "Audit Trail"],
            },
        ],
        "features_stats": {"uptime": "99.9%", "response": "<50ms", "encryption": "256-bit", "support": "24/7"},
        "benefits_title": "Why Hospital-Specific Solution?",
        "benefits": [
            {
                "title": "High-Volume Lab Outputs",
                "desc": "Hundreds of test results daily. Automate structuring, ensure consistency, and prepare for expert review with NoryaAI.",
                "stats": {"primary": "85%", "primary_label": "Time Savings", "secondary": "500+", "secondary_label": "Daily Analyses"},
            },
            {
                "title": "Multi-Disciplinary Team Coordination",
                "desc": "Create consistent reporting language and workflow standards across laboratory, clinic, emergency, and admin units.",
                "stats": {"primary": "100%", "primary_label": "Standardization", "secondary": "12+", "secondary_label": "Departments"},
            },
            {
                "title": "Multilingual Patient Communication",
                "desc": "Present results in 12+ languages for international patients, health tourism, and multicultural communities.",
                "stats": {"primary": "12+", "primary_label": "Languages", "secondary": "50+", "secondary_label": "Countries"},
            },
        ],
        "teams_title": "Who Can Use It?",
        "teams_desc": "NoryaAI is designed to add value at different points of the hospital organization.",
        "teams": [
            {"title": "Laboratory Teams", "desc": "Structure high-volume test outputs for pre-review, creating organized infrastructure before specialist examination."},
            {"title": "Clinical Teams", "desc": "Structured pre-analyses help clinicians enter patient consultations better prepared."},
            {"title": "Emergency Department", "desc": "In fast-decision environments, structured summary outputs support quicker comprehension of lab results."},
            {"title": "Management & Operations", "desc": "Quota management, usage tracking, and corporate audit features designed for hospital leadership."},
        ],
        "use_cases_title": "Hospital Use Cases",
        "use_cases": [
            {"title": "Pre-structuring Lab Results", "desc": "Raw lab results are prepared in structured and categorized form before clinician review."},
            {"title": "Multilingual Patient Info", "desc": "Results can be transformed into understandable summaries in multiple languages based on patient profile."},
            {"title": "Consistent Cross-Unit Reporting", "desc": "Enables different departments to share results in same standard and language. Reduces inconsistent interpretation risk."},
            {"title": "Operational Load Reduction", "desc": "Automates repetitive prep steps, freeing teams to focus on critical tasks."},
            {"title": "Corporate Usage Tracking", "desc": "Access operational data like unit-wise analysis counts, quota usage, and audit records via corporate panel."},
            {"title": "Health Tourism Support", "desc": "Present results in patients' own languages, supporting hospital's international service quality."},
        ],
        "security_title": "Corporate Security & Governance",
        "security_desc": "Access control, traceability, and clinical oversight infrastructure required by hospital environments.",
        "security_points": [
            {"title": "Privacy-First Data Processing", "desc": "Sensitive clinical data processed with data minimization principles and comprehensive access restrictions."},
            {"title": "Role-Based Access Control", "desc": "User permissions configured by corporate roles, teams access only relevant workflows."},
            {"title": "Traceable Workflow Logic", "desc": "Workflow actions organized to support traceable review steps and corporate audit documentation."},
            {"title": "Controlled Internal Access", "desc": "Operational access limited to approved internal teams for clear accountability."},
            {"title": "Multilingual Corporate Support", "desc": "Structured multilingual outputs support standardization for cross-border teams and patient communication."},
            {"title": "Clinician Oversight", "desc": "Clinical teams review and control all outputs before patient communication use."},
        ],
        "pricing_title": "Enterprise Solutions",
        "pricing_desc": "Scalable solutions based on your hospital's size and needs",
        "pricing_tiers": [
            {
                "name": "Professional",
                "label": "For mid-size hospitals",
                "price": "Starting ₺49K",
                "period": "/month",
                "cta": "Get Quote",
                "features": ["5,000 analyses/month", "12+ languages", "Basic integrations", "5 user licenses", "Email support", "Monthly usage report"],
            },
            {
                "name": "Enterprise",
                "label": "For large hospitals & groups",
                "price": "Custom",
                "period": "pricing",
                "cta": "Request Demo",
                "featured": True,
                "features": ["Unlimited analyses", "12+ languages + custom translations", "HL7/FHIR integration", "Unlimited users", "24/7 priority support", "Custom dashboard & analytics", "Dedicated account manager", "SLA guarantee (99.9% uptime)"],
            },
            {
                "name": "Premium Enterprise",
                "label": "For hospital chains & international",
                "price": "Starting ₺149K",
                "period": "/month",
                "cta": "Contact Us",
                "features": ["All Enterprise features", "Multi-hospital management", "Custom AI model training", "White-label options", "Custom SLA terms", "On-site training & support", "Advanced analytics & BI"],
            },
        ],
        "pricing_footer": "All enterprise plans include custom integration, security, and compliance features.",
        "pilot_title": "Start with Pilot Deployment",
        "pilot_desc": "Evaluate the system with a limited-scope pilot in a specific department. Measure results before corporate contract.",
        "pilot_steps": [
            {"title": "Define Scope", "desc": "Pilot department, user count, and monthly quota determined together."},
            {"title": "Pilot Implementation", "desc": "Designated team starts using system in real workflows."},
            {"title": "Evaluate & Expand", "desc": "Pilot results reviewed together; if suitable, move to corporate scale."},
        ],
        "workflow_title": "Hospital Workflow",
        "workflow_steps": [
            {"title": "Upload Results", "desc": "Lab results uploaded as PDF, image, or text."},
            {"title": "Structured Pre-Analysis", "desc": "AI prepares results in structured and categorized form."},
            {"title": "Multilingual Summary", "desc": "Results prepared as understandable summaries in multiple languages if needed."},
            {"title": "Clinician Review", "desc": "Clinical or ops team reviews outputs for appropriateness."},
            {"title": "Ready Output", "desc": "Approved outputs ready for patient info or internal reporting."},
        ],
...
def _page_hospitals_tr() -> Dict[str, Any]:
    return {
        ...
        "who_secondary": "Üniversite Hastaneleri ve Özel Klinikler",
        "who_points": ["Yüksek hacimli laboratuvar hizmetleri", "Çok kampüslü operasyonlar", "Uluslararası hasta hizmetleri"],
        "features_title": "Premium Kurumsal Özellikler",
        "features": [
            {
                "title": "Gelişmiş AI Analitiği",
                "badge": "AI POWERED",
                "desc": "Laboratuvar verilerinizden otomatik içgörüler. Anormal paternleri tespit eder, trend analizleri sunar ve klinik karar desteği sağlar.",
                "points": ["Patern Tanıma", "Trend Analizi", "Risk Skorlaması"],
            },
            {
                "title": "Gerçek Zamanlı İzleme",
                "badge": "REAL-TIME",
                "desc": "Tüm laboratuvar iş akışınızı canlı olarak izleyin. Anlık bildirimler, performans metrikleri ve operasyonel dashboard.",
                "points": ["Canlı Dashboard", "Anlık Uyarılar", "KPI Takibi"],
            },
            {
                "title": "Özel Entegrasyon",
                "badge": "CUSTOM",
                "desc": "Mevcut HIS, LIS ve EHR sistemlerinizle sorunsuz entegrasyon. RESTful API, HL7 FHIR desteği ve özel connector'lar.",
                "points": ["HL7 FHIR", "RESTful API", "Webhook Desteği"],
            },
            {
                "title": "Uyumluluk & Güvenlik",
                "badge": "CERTIFIED",
                "desc": "KVKK, HIPAA ve GDPR uyumlu. Tam denetim izleri, rol bazlı erişim kontrolü ve uçtan uca şifreleme.",
                "points": ["KVKK / GDPR", "HIPAA Uyumlu", "Audit Trail"],
            },
        ],
        "features_stats": {"uptime": "99.9%", "response": "<50ms", "encryption": "256-bit", "support": "24/7"},
        "benefits_title": "Neden Hastaneye Özel Bir Çözüm?",
        "benefits": [
            {
                "title": "Yüksek Hacimli Laboratuvar Çıktıları",
                "desc": "Günde yüzlerce tahlil sonucu üretilir. NoryaAI ile her birini otomatik olarak yapılandırın, tutarlılığı sağlayın ve uzman incelemesi için hazırlayın.",
                "stats": {"primary": "85%", "primary_label": "Zaman Tasarrufu", "secondary": "500+", "secondary_label": "Günlük Analiz"},
            },
            {
                "title": "Çok Disiplinli Ekip Koordinasyonu",
                "desc": "Laboratuvar, klinik, acil servis ve idari birimler arasında tutarlı bir raporlama dili ve iş akışı standardı oluşturun.",
                "stats": {"primary": "100%", "primary_label": "Standartlaşma", "secondary": "12+", "secondary_label": "Departman Desteği"},
            },
            {
                "title": "Farklı Dillerde Hasta İletişimi",
                "desc": "Uluslararası hastalar, sağlık turizmi ve çok kültürlü topluluklar için sonuçları 12+ dilde anlaşılır biçimde sunun.",
                "stats": {"primary": "12+", "primary_label": "Dil Desteği", "secondary": "50+", "secondary_label": "Ülke Kapsamı"},
            },
        ],
        "teams_title": "Hastane İçinde Kimler Kullanabilir?",
        "teams_desc": "NoryaAI, hastane organizasyon şemasının farklı noktalarına değer katacak şekilde tasarlanmıştır.",
        "teams": [
            {"title": "Laboratuvar Ekipleri", "desc": "Yüksek hacimli tahlil çıktılarını yapılandırılmış biçimde ön hazırlığa alarak uzman incelemesi öncesinde düzenli bir alt yapı oluşturur."},
            {"title": "Klinik Ekipler", "desc": "Yapılandırılmış ön analizler, klinisyenin hasta görüşmesine daha hazırlıklı girmesine yardımcı olabilir."},
            {"title": "Acil Servis", "desc": "Hızlı karar alınması gereken ortamlarda yapılandırılmış özet çıktılar, tahlil sonuçlarının daha çabuk kavranmasına destek olabilir."},
            {"title": "Yönetim ve Operasyon", "desc": "Kota yönetimi, kullanım takibi ve kurumsal denetim özellikleri, hastane yönetim ekiplerinin ihtiyaçlarına göre tasarlanmıştır."},
        ],
        "use_cases_title": "Hastaneye Özgü Kullanım Alanları",
        "use_cases": [
            {"title": "Tahlil Sonuçlarının Ön Yapılandırması", "desc": "Laboratuvardan çıkan ham sonuçlar, klinisyen incelemesi öncesinde yapılandırılmış ve kategorize edilmiş biçimde hazırlanır."},
            {"title": "Çok Dilli Hasta Bilgilendirme Desteği", "desc": "Sonuçlar, hastanenin hizmet verdiği hasta profiline göre birden fazla dilde anlaşılır özetlere dönüştürülebilir."},
            {"title": "Birimler Arası Tutarlı Raporlama", "desc": "Farklı bölümlerin aynı standart ve dilde sonuç paylaşmasını kolaylaştırır. Tutarsız yorum riskini azaltmayı hedefler."},
            {"title": "Operasyonel Yük Azaltma", "desc": "Tekrarlayan ön hazırlık adımlarını otomatikleştirerek ekiplerin daha kritik görevlere odaklanmasına alan açmayı amaçlar."},
            {"title": "Kurumsal Kullanım Takibi", "desc": "Hangi birimde, kaç analiz yapıldığı, kota kullanımı ve denetim kaydı gibi operasyonel verilere kurumsal panel üzerinden erişim."},
            {"title": "Sağlık Turizmi Desteği", "desc": "Uluslararası hastalara sonuçlarını kendi dillerinde sunarak hastanenin uluslararası hizmet kalitesini desteklemeyi hedefler."},
        ],
        "security_title": "Kurumsal Güvenlik ve Yönetişim",
        "security_desc": "Hastane ortamının gerektirdiği erişim kontrolü, izlenebilirlik ve klinik gözetim altyapısı.",
        "security_points": [
            {"title": "Gizlilik Odaklı Veri İşleme", "desc": "Hassas klinik veriler, veri minimizasyonu ilkeleri ve kapsamlı erişim kısıtlamalarıyla işlenir."},
            {"title": "Rol Bazlı Erişim Kontrolü", "desc": "Kullanıcı yetkileri, kurumsal rollere göre yapılandırılarak her ekip yalnızca ilgili iş akışlarına erişir."},
            {"title": "İzlenebilir İş Akışı Mantığı", "desc": "İş akışı aksiyonları, izlenebilir gözden geçirme adımlarını ve kurumsal denetim dokümantasyonunu destekleyecek şekilde organize edilmiştir."},
            {"title": "Kontrollü Kurum İçi Erişim", "desc": "Operasyonel erişim, onaylı kurum içi ekiplerle sınırlandırılarak net hesap verebilirlik sağlanır."},
            {"title": "Çok Dilli Kurumsal Destek", "desc": "Yapılandırılmış çok dilli çıktılar, sınır ötesi ekipler ve hasta iletişimi bağlamında standartlaşmayı destekler."},
            {"title": "Klinisyen Gözetimi", "desc": "Klinik ekipler, hasta iletişiminde kullanılmadan önce tüm çıktıları gözden geçirir ve kontrol eder."},
        ],
        "pricing_title": "Kurumsal Çözümler",
        "pricing_desc": "Hastanenizin büyüklüğüne ve ihtiyaçlarına göre ölçeklenebilir çözümler",
        "pricing_tiers": [
            {
                "name": "Professional",
                "label": "Orta ölçekli hastaneler ve klinikler için",
                "price": "₺49K",
                "period": "/aydan başlayan",
                "cta": "Teklif Alın",
                "features": ["Aylık 5,000 analiz kotası", "12+ dil desteği", "Temel entegrasyonlar", "5 kullanıcı lisansı", "E-posta desteği", "Aylık kullanım raporu"],
            },
            {
                "name": "Enterprise",
                "label": "Büyük hastaneler ve hastane grupları için",
                "price": "Özel",
                "period": "fiyatlandırma",
                "cta": "Demo Talep Et",
                "featured": True,
                "features": ["Sınırsız analiz kotası", "12+ dil + özel çeviriler", "HL7/FHIR entegrasyonu", "Sınırsız kullanıcı", "7/24 öncelikli destek", "Özel dashboard & analitik", "Dedike hesap yöneticisi", "SLA garantisi (%99.9 uptime)"],
            },
            {
                "name": "Premium Enterprise",
                "label": "Hastane zincirleri ve uluslararası kurumlar için",
                "price": "₺149K",
                "period": "/aydan başlayan",
                "cta": "İletişime Geçin",
                "features": ["Enterprise özelliklerinin tamamı", "Çoklu hastane yönetimi", "Özel AI model eğitimi", "White-label seçenekleri", "Özel SLA koşulları", "Yerinde eğitim & destek", "Gelişmiş analitik & BI"],
            },
        ],
        "pricing_footer": "Tüm kurumsal planlar özel entegrasyon, güvenlik ve uyumluluk özellikleri içerir.",
        "pilot_title": "Pilot Dağıtım ile Başlayın",
        "pilot_desc": "Hastanenizin belirli bir bölümünde sınırlı kapsamlı bir pilot ile başlayarak sistemi değerlendirin. Kurumsal sözleşme öncesinde sonuçları ölçün.",
        "pilot_steps": [
            {"title": "Kapsam Belirleme", "desc": "Pilot bölüm, kullanıcı sayısı ve aylık kota birlikte belirlenir."},
            {"title": "Pilot Uygulama", "desc": "Belirlenen ekip, gerçek iş akışlarında sistemi kullanmaya başlar."},
            {"title": "Değerlendirme ve Genişleme", "desc": "Pilot sonuçları birlikte değerlendirilir; uygunsa kurumsal ölçeğe geçilir."},
        ],
        "workflow_title": "Hastane İş Akışı",
        "workflow_steps": [
            {"title": "Sonuç Yükleme", "desc": "Laboratuvar sonuçları PDF, görsel veya metin olarak sisteme yüklenir."},
            {"title": "Yapılandırılmış Ön Analiz", "desc": "Yapay zekâ, sonuçları yapılandırılmış ve kategorize edilmiş biçimde ön hazırlığa alır."},
            {"title": "Çok Dilli Özet", "desc": "İhtiyaç halinde sonuçlar birden fazla dilde anlaşılır özet biçiminde hazırlanır."},
            {"title": "Klinisyen Gözden Geçirme", "desc": "Klinik veya operasyonel ekip, çıktıları gözden geçirir ve uygunluğunu değerlendirir."},
            {"title": "Kullanıma Hazır Çıktı", "desc": "Onaylanan çıktılar, hasta bilgilendirme veya kurum içi raporlama amacıyla kullanılabilir hale gelir."},
        ],
