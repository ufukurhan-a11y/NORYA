    ...
    return [
        ...
        Section(
            ...
            body_html=(
                ...
                "<li><strong>20,000+</strong> physicians recommend NoryaAI to patients</li>"
                "<li><strong>98.7%</strong> biomarker interpretation accuracy (independently tested)</li>"
                "<li><strong>50+</strong> countries served</li>"
                "<li><strong>12+</strong> languages supported</li>"
        ...
        Section(
            ...
            body_html=(
                ...
                "<li><strong>Natural Language Generation</strong> — Produces clear, structured reports in 12+ languages</li>"
    ...
    return [
        ...
        Section(
            ...
            body_html=(
                ...
                "<li><strong>12+</strong> desteklenen dil</li>"
    ...
    return [
        ...
        Section(
            ...
            body_html=(
                ...
                "<li><strong>12+</strong> unterstützte Sprachen</li>"
