...
UI = {
    ...
    "el": {
        ...
        "footer_company_info_title": "Στοιχεία επικοινωνίας και εταιρείας",
        "footer_tax_office_label": "ΔΟΥ",
        "footer_tax_no_label": "ΑΦΜ",
    },
    "cs": {
        "back_to_home": "← Domů",
        ...
        "footer_company_info_title": "Kontaktní a firemní údaje",
        "footer_tax_office_label": "Finanční úřad",
        "footer_tax_no_label": "Daňové identifikační číslo",
    },
    "sr": {
        ...
        "nav_legal": "Правне информације",
        "footer_company_info_title": "Контакт и подаци о компанији",
        "footer_tax_office_label": "Пореска управа",
        "footer_tax_no_label": "Порески број",
    },
}
...
PRIVACY = {
    "tr": {
        ...
        "summary": [
            {"label": "Hangi verileri topluyoruz", "text": "İletişim bilgileri, hesap verileri, yüklenen laboratuvar sonuçları, ödeme kayıtları ve hizmet sunumu için gerekli teknik veriler."},
            {"label": "Neden kullanıyoruz", "text": "Analiz hizmetini sunmak, ödemeleri işlemek, teknik destek sağlamak ve yasal yükümlülükleri yerine getirmek için. Verilerinizi reklam amacıyla satmıyoruz."},
            {"label": "Ne kadar süre saklıyoruz", "text": "Veriler hesabınız aktif olduğu sürece saklanır. Silme talebinde yasal saklama gereklilikleri dışında veriler kaldırılır."},
            {"label": "Ödeme bilgileri", "text": "Kredi kartı bilgileri sunucularımızda saklanmaz. Ödeme işlemleri PCI uyumlu sağlayıcılar aracılığıyla yapılır."},
            {"label": "Yüklenen dosyalar", "text": "Yüklediğiniz laboratuvar sonuçları analiz raporunuzu oluşturmak için işlenir. Dosyalar erişim kontrolleri ve aktarım sırasında şifreleme ile korunur."},
            {"label": "Bize nasıl ulaşabilirsiniz", "text": "Gizlilik soruları için support@noryaai.com adresine veya İletişim sayfamız üzerinden bize ulaşabilirsiniz."},
            {"label": "Veri silme", "text": "Hesabınızın ve verilerinizin silinmesini istediğiniz zaman talep edebilirsiniz. Talepler geçerli veri koruma düzenlemelerine uygun şekilde işlenir."},
        ],
        "summary_title": "Gizlilik Özeti",
        "summary_note": "Bu özet kolaylık sağlamak amacıyla sunulmuştur. Aşağıdaki tam gizlilik politikası geçerli belgedir.",
    ...
    "en": {
        ...
        "summary": [
            {"label": "What we collect", "text": "Contact information, account data, uploaded lab results, payment records, and technical data necessary to provide the service."},
            {"label": "Why we use it", "text": "To deliver the analysis service, process payments, provide technical support, and meet legal obligations. We do not sell your data for advertising."},
            {"label": "How long we retain data", "text": "Data is retained while your account is active. On deletion request, data is removed except where legal retention requirements apply."},
            {"label": "Payment information", "text": "Credit card details are never stored on our servers. Payment processing is handled by PCI-compliant providers."},
            {"label": "Uploaded files", "text": "Lab results you upload are processed to generate your analysis report. Files are handled with access controls and encryption in transit."},
            {"label": "How to contact us", "text": "For privacy inquiries, contact support@noryaai.com or use our Contact page."},
            {"label": "Data deletion", "text": "You can request deletion of your account and data at any time. We process requests in accordance with applicable data protection regulations."},
        ],
        "summary_title": "Privacy at a Glance",
        "summary_note": "This summary is provided for convenience. The full privacy policy below is the governing document.",
...
TERMS = {
    "tr": {
        ...
        "last_updated": "Son güncelleme: Mart 2026",
        "summary": [
            {"label": "Eğitim aracı", "text": "NoryaAI eğitim amaçlı bir sağlık teknolojisi platformudur. Tıbbi teşhis koymaz ve profesyonel tıbbi tavsiyenin yerini almaz."},
            {"label": "Kullanıcı sorumluluğu", "text": "Yüklediğiniz bilgilerin doğruluğundan ve tıbbi kararlar için sağlık profesyonellerine danışmaktan siz sorumlusunuz."},
            {"label": "Ödeme ve erişim", "text": "Bazı hizmetler ücretlidir. Ödemeler üçüncü taraf sağlayıcılar aracılığıyla işlenir. Hesap koşulları ve fiyatlandırma aşağıda detaylı olarak açıklanmıştır."},
            {"label": "Kabul edilebilir kullanım", "text": "Hizmeti yasal ve sorumlu bir şekilde kullanın. Başkalarının verilerini izinsiz yüklemeyin veya platformu kötüye kullanmaya çalışmayın."},
            {"label": "İletişim", "text": "Bu şartlar hakkında sorularınız için support@noryaai.com adresine veya İletişim sayfamız üzerinden bize ulaşabilirsiniz."},
        ],
        "summary_title": "Şartlar Özeti",
        "summary_note": "Bu özet hızlı referans içindir. Aşağıdaki tam şartlar geçerli belgedir.",
    ...
    "en": {
        ...
        "last_updated": "Last updated: March 2025",
        "summary": [
            {"label": "Educational tool", "text": "NoryaAI is an educational health technology platform. It does not provide medical diagnoses or replace professional medical advice."},
            {"label": "User responsibility", "text": "You are responsible for the accuracy of information you upload and for consulting healthcare professionals for medical decisions."},
            {"label": "Payment & access", "text": "Some services require payment. Payments are processed through third-party providers. Account terms and pricing are described in detail below."},
            {"label": "Acceptable use", "text": "Use the service lawfully and responsibly. Do not upload others' data without permission or attempt to misuse the platform."},
            {"label": "Contact", "text": "For questions about these terms, contact support@noryaai.com or use our Contact page."},
        ],
        "summary_title": "Terms Summary",
        "summary_note": "This summary is for quick reference. The full terms below are the governing document.",
