...
LANDING_META = {
    ...
    "de": {
        "meta_title": "Norya — Zuverlässige KI-Blutanalyse",
        "meta_description": "Laborergebnisse verständlich erklärt. PDF oder Foto hochladen, klarer Bericht und PDF. 9 Sprachen, datenschutzorientiert.",
        "og_locale": "de_DE",
    },
    "it": {
...
def _de_ui() -> dict:
    ...
    return {
        ...
        "hero_sub": "Clinical Biomarker Platform",
        "hero_title": "Ihr Blutbild in 60 Sekunden verstehen",
        "hero_desc": "Laden Sie Ihre Laborergebnisse hoch — strukturierte Auswertung und klinischer Premium-Bericht.",
        "hero_cta": "Analyse starten",
        "hero_see_sample": "Beispielbericht ansehen",
        "trust_badge_ssl": "256-bit SSL",
        "trust_badge_kvkk_gdpr": "KVKK & GDPR",
        "trust_badge_paytr": "PayTR sichere Zahlung",
        "trust_badge_qr": "QR-Berichtsprüfung",
        "cta_features_heading": "Bereit für Ihren Bericht?",
        "cta_features_sub": "Laden Sie Ihre Laborergebnisse hoch und erhalten Sie in Minuten einen klaren Bericht.",
        ...
        "faq_a4": "Türkisch, Englisch, Italienisch, Spanisch, Französisch, Deutsch und weitere.",
        ...
        "pricing_eur": "Preise werden in Ihrer lokalen Währung angezeigt.",
        "drawer_trust_meta": "KVKK & GDPR · 256-bit SSL · Sichere Zahlung",
