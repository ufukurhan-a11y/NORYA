...
<body>
  <div id="login" class="login-box">
    <h1><img src="/static/norya_logo_transparent_trim.png" alt="Norya" class="brand-logo" />Norya Admin</h1>
  ...
  <div id="dashboard" class="dashboard">
    <h1><img src="/static/norya_logo_transparent_trim.png" alt="Norya" class="brand-logo" />Norya Admin Panel</h1>
