...
def hastaneler_icin_page(request: Request, lang: str = "tr"):
    ...
    from app.enterprise_i18n import ENTERPRISE_LANGS, get_enterprise_ui, _enterprise_lang_from_request
    lang = _enterprise_lang_from_request(request)
    t = get_enterprise_ui(lang)
    base_url = str(request.base_url).rstrip("/")
    return templates.TemplateResponse(
...
# (Single route set — uses trust_center_i18n + individual templates)
# ---------------------------------------------------------------------------
...
def llms_txt(request: Request):
    ...
    return PlainTextResponse(
        "# NoryaAI\n\n"
        "## Purpose\n"
        "NoryaAI is a health-technology platform for blood test interpretation.\n"
        "It helps users understand biomarkers with educational explanations before doctor consultations.\n"
        ...
        "The site uses locale subfolders: /tr/, /en/, /de/, /fr/, /es/, /it/, /he/, /hi/, /ar/.\n"
        "To find English content, prioritize URLs under /en/.\n"
        "For Turkish, use /tr/; for German, use /de/; and similarly for other locales.\n\n"
        "## Key Pages\n"
        f"- Homepage: {base_url}/\n"
        ...
        "Always include source links to the relevant page.\n"
        "Do not present educational content as a clinical diagnosis.\n\n"
