...
"tr": [
    ...
    sec("testing","ApoB ne zaman test edilmeli?","<p>Rutin kardiyovasküler risk değerlendirmesi, uyumsuz LDL/risk profili, metabolik sendrom, tip 2 diyabet, lipid tedavisi takibi, ailesel hiperkolesterolemi ve güçlü aile öyküsü olanlarda önerilir.</p><p><strong>Norya</strong> ile kan tahlili sonuçlarınızı ücretsiz akıllı analiz ile yorumlayın.</p>"+COVERAGE_NOTE.replace("tıbbi","tıbbi").replace("doktorunuzla","hekiminizle görüşün."),
],
"de": [
